  ...
  <div class="flex-1">
    ...
    <div class="hero-bg relative">
      <div class="relative z-10 max-w-4xl mx-auto px-4 pt-20 pb-16">
        ...
        >
          Upload your resume, paste the job description, and let our AI optimize
          it for Applicant Tracking Systems. Get a professional template ready
          to download.
        </p>
        ...
        >
          <div class="text-center">
            ...
            <p class="text-xs text-slate-400">ATS Score Analysis</p>
          </div>
          <div class="text-center">
            <div
              class="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center mx-auto mb-2"
            ...
            <p class="text-xs text-slate-400">5 Pro Templates</p>
          </div>
          <div class="text-center">
            <div
              class="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center mx-auto mb-2"
            >
              <UIcon name="i-lucide-download" class="w-5 h-5 text-green-400" />
            </div>
            <p class="text-xs text-slate-400">PDF & DOCX Export</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-2xl mx-auto px-4 mt-6 relative z-20 pb-16">
      ...
      >
        ...
        >
          <div class="space-y-3">
            ...
            <div>
              ...
              <p class="text-sm text-slate-500 mt-1">PDF or DOCX • Max 10MB</p>
            </div>
            <UButton
              variant="outline"
              size="sm"
            ...
            >
              <UIcon name="i-lucide-folder-open" class="w-4 h-4 mr-1.5" />
              Browse Files
            </UButton>
            <input
              ref="fileInput"
        ...
        >
          ...
          <UButton variant="ghost" color="error" size="xs" @click="clearFile">
        ...
        <div class="mt-5 space-y-2">
          ...
          >
            <UIcon name="i-lucide-briefcase" class="w-4 h-4 text-slate-500" />
            Job Description
          </label>
          <UTextarea
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p v-if="store.error.hint" class="mt-1 text-xs text-red-400/80">
                {{ store.error.hint }}
              </p>
              <p
              ...
              >
                <span v-if="store.error.code"
                  >Code: {{ store.error.code }}</span
                >
                <span v-if="store.error.code && store.error.requestId">
                  —
                </span>
                <span v-if="store.error.requestId"
                  >Ref: {{ store.error.requestId }}</span
                >
              </p>
            </div>
          </div>
